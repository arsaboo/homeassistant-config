...
wget -O /home/homeassistant/.homeassistant/www/custom_ui/calendar-card.js https://github.com/ljmerza/calendar-card/releases/download/3.11.4/calendar-card.js
wget -O /home/homeassistant/.homeassistant/www/custom_ui/mini-graph-card-bundle.js https://github.com/kalkih/mini-graph-card/releases/download/v0.5.0/mini-graph-card-bundle.js
wget -O /home/homeassistant/.homeassistant/www/custom_ui/mini-media-player-bundle.js https://github.com/kalkih/mini-media-player/releases/download/v1.2.2/mini-media-player-bundle.js
