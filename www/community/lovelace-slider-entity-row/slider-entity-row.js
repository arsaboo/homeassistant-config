    ...
    <div class="wrapper" @click=${t=>t.stopPropagation()}>
      ${"unavailable"===t.stateObj.state?a`
        ...
        `:a`
            ...
            ${this.hide_state?"":a`
                  ${this._config.toggle?t.hasToggle?i:"":this._config.hide_state?"":a`
                          <span class="state">
                            ${t.string}
                          </span>
                        `}
