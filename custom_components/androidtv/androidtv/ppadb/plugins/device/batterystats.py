from custom_components.androidtv.androidtv.ppadb.plugins.device import batterystats_section as section_module
from custom_components.androidtv.androidtv.ppadb.plugins import Plugin
