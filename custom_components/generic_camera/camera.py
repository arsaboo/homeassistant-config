...
CONF_PRELOAD_STREAM = 'preload_stream'
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Optional(CONF_PRELOAD_STREAM, default=False): cv.boolean,
})
...
async def async_setup_platform(hass, config, async_add_entities,
    ...
    if config[CONF_PRELOAD_STREAM] and config[CONF_STREAM_SOURCE]:
        request_stream(hass, config[CONF_STREAM_SOURCE], keepalive=True)
