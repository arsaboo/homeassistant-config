...
RashmiTrackers = ['device_tracker.iphone_3', 'device_tracker.rashmiphone_rashmiphone_2',
                  'device_tracker.rashmiappiphone_2', 'device_tracker.life360_sonu',
                  'device_tracker.e1594e53_21df_414c_82da_f655d5282fca']
AlokTrackers = ['device_tracker.aloks_iphone_3', 'device_tracker.alokphone_alokphone_2',
